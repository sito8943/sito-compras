        ...
        _transitionTo(r, i, s) {
            if (this._state === i || this._state === s)
                ...
                throw new Error(
                    `${this.type} '${
                        this.source
                    }': can not transition to '${r}', expecting state '${i}'${
                        s ? " or '" + s + "'" : ''
                    }, was '${this._state}'.`
                )
        }
                    ...
                    try {
                        if (P.hasOwnProperty(T)) {
                            ...
                            Z && Z.value
                                ...
                                : P[T] &&
                                  (P[T] = e.wrapWithCurrentZone(P[T], I))
